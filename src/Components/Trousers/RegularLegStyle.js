  ...
  return (
    <div>
      ...
      <div className=" bg-[#15171F]">
        ...
        {/* Back pocket */}
        <div className="grid grid-cols-3 grid-row-4 text-[12px] font-[AcuminVariable] p-2">
      ...
      <div className=" bg-[#15171F]  font-[AcuminVariable] mt-[24px]">
        <article className="text-white text-[15px] p-2 font-[AcuminVariable1]">Front Pocket</article>
        {/* Front pocket */}

        <div className="grid grid-cols-3 grid-rows-1 text-[12px]">
          <div className="text-white mt-[10px] mx-2 mb-2">TICKET POCKET</div>
      ...
      <div className=" bg-[#15171F] p-2 mt-[24px] font-[AcuminVariable] ">
        <article className="text-white flex justify-start text-[15px] font-[AcuminVariableConcept] p-1">HEM Style</article>
        {/* Hem style */}
        <div className="grid grid-cols-4 grid-rows-2 p-1 text-[12px]">
